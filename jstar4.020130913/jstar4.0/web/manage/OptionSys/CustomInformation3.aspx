<%@ Page Title="" Language="C#" MasterPageFile="~/manage/MasterPage.master" AutoEventWireup="true" CodeFile="CustomInformation3.aspx.cs" Inherits="manage_OptionSys_CustomInformation3" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div class="divpagetitle">
        <asp:Label ID="lbltitle" runat="server" Text="首页自定义编辑1"></asp:Label>
        <uc1:ShowMsg ID="ShowMsg1" runat="server" />
    </div>
    <table class="TableList">
                        <tr>
                            <td class="FirstCol">
                                <asp:Label ID="lblnType" runat="server" Text="自定义3(中文)"></asp:Label>
                        ...
                        <tr>
                            <td class="FirstCol">
                                <asp:Label ID="lblsLink" runat="server" Text="自定义3(英文)"></asp:Label>
                            </td>
                            <td class="SecondCol">
